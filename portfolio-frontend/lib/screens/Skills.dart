...
class _SkillsState extends State<Skills> with TickerProviderStateMixin {
                  ...
                  child: Row(
                      ...
                      children: [
                        ...
                        ChangeNotifierProvider(
                            ...
                            child: Consumer<SkillsProvider>(
                                builder: (context, value, child) {
                              return skillCard(w, h, "Frontend", frontendTechs,
  ...
  // Widget skillCard(double w, double h, String name, List l) {
  //   return Container(
  ...
  //             )),
  //         Divider(color: globals.blackish, thickness: 1),
  //         ...(List.generate(
  //             l.length,
  //             (index) => Container(
  //                   margin: EdgeInsets.only(top: (h / 100) * 1),
  ...
  //                     l[index],
  //                     style:
  //                         globals.ts((w / 100) * 1.25, globals.blackish, null),
  //                   ),
  //                 )))
  //       ]));
  // }
